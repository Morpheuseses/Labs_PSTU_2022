...
int main()
{
	...
	showList(list, size);
	int cnt; // quantity of elements we want to delete
	std::cout << "Enter count of element you want to delete and from what position it will be deleted: ";
	std::cin >> pos >> cnt;
